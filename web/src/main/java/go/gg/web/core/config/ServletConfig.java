...
import go.gg.web.core.controller.BaseController;
import go.gg.web.core.interceptor.WebInterceptor;
import go.gg.web.core.util.WebPaginationRenderer;
...
public class ServletConfig extends WebMvcConfigurationSupport {
	...
	@Bean
	public WebPaginationRenderer webPageRenderer(){
		return new WebPaginationRenderer();
	}

	@Bean
	public DefaultPaginationManager paginationManager(WebPaginationRenderer webPageRenderer){
		...
		rendererType.put("webPage", webPageRenderer);
