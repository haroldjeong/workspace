...
@ComponentScan({"go.gg.web.core.config"})   // @ComponentScan : Bean 등록을 하였음에도 Autowired 에서 자동으로 찾지 못하는 경우 직접 해당 위치(패키지)를 지정하여 스캔하도록 설정. eclipse는 이런 현상이 없으나 IntelliJ 내에서 종종 발생 (jm.lee)
