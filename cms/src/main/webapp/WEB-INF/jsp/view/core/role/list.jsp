						...
						<div class="form-row">
							...
							<div class="form-group col-lg-6">
								...
								<div class="input-group input-group">
									<input class="form-control" placeholder="<spring:message code="search.placeholder" text="검색구분 선택 후, 검색어를 입력해주세요."/>" name="searchKeyword" id="searchKeyword" value="<c:out value="${condition.searchKeyword}" />" autocomplete="off" />
							...
							<table class="table table-striped table-hover">
								...
								<thead>
									<tr>
										...
										<th class="text-center"><spring:message code="role.list.modId" text="수정자"/></th>
								...
								<c:if test="${fn:length(resultList) eq 0}">
									<tr>
										<td colspan="8" class="text-center"><spring:message code="search.content.none" text="조회 결과가 없습니다."/></td>
									</tr>
								</c:if>
