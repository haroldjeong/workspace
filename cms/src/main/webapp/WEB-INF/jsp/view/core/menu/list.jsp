	...
	<div class="col-lg-4">
		<div class="ibox float-e-margins">
			<div class="ibox-content mailbox-content">
				<div class="btn-group">
					<button class="btn btn-white btn-sm m-n" onclick="flow.render.tree.openAll();"><spring:message code="menu.list.allopen" text="모두 열기"/></button>
					<button class="btn btn-white btn-sm m-n" onclick="flow.render.tree.closeAll();"><spring:message code="menu.list.allclose" text="모두 접기"/></button>
				</div>
			...
			<div class="col-lg-12">
				<div id="_info" class="panel panel-default m-t">
					<div class="panel-body">
						<h3><spring:message code="menu.list.tip_01" text="좌측 트리에서 코드를 선택하세요."/></h3>
						<p><spring:message code="menu.list.tip_02" text="최상위 코드를 등록 하시려면 아래 버튼을 선택 하세요."/></p>
						<button type="button" class="btn btn-success btn-sm" title="<spring:message code="menu.list.topsave" text="최상위 코드 등록"/>" onclick="flow.render.form('ADD-TOP');">
							<i class="fa fa-pencil-square"></i> <spring:message code="menu.list.topsave" text="최상위 코드 등록"/>
						</button>
					</div>
				</div>
				...
				<div class="panel panel-default m-t _flow-code-detail" style="display:none;">
					...
					<div class="panel-body">
						...
						<tr>
							<th><spring:message code="menu.list.shrtDesc" text="짧은 표기명"/></th>
						...
						<tr>
							<th><spring:message code="menu.list.longDesc" text="전체 표기명"/></th>
						...
						<tr>
							<th><spring:message code="menu.list.linkUrl" text="링크 URL"/></th>
							<td data-detail="linkUrl"></td>
						</tr>
						<tr>
							<th><spring:message code="menu.list.linkType" text="링크 유형"/></th>
							<td data-detail="linkType"></td>
						</tr>
						<tr>
							<th><spring:message code="menu.list.iconType" text="아이콘 유형"/></th>
							<td data-detail="iconType"></td>
						</tr>
						<tr>
							<th><spring:message code="menu.list.useYn" text="사용 여부 "/>*</th>
				...
				<form method="post" class="form-horizontal" name="default" id="frmDefault">
					<div class="panel panel-default m-t _flow-code-form" style="display:none;">
						...
						<div class="panel-body">
							<table class="table table-detail"><colgroup><col width="150"/><col/></colgroup><tbody>
							<tr>
								<th><spring:message code="menu.list.code" text="코드" /> *</th>
								<td>
									<input type="text" class="form-control" name="cd" value="" title="<spring:message code="menu.list.code.title" text="코드는 필수 입력 항목입니다." />" maxlength="30" autocomplete="off" data-form="cd" required="required"/>
								</td>
							</tr>
							<tr>
								<th><spring:message code="menu.list.name" text="표기명" /> *</th>
								<td>
									<input type="text" class="form-control" name="name" value="" title="<spring:message code="menu.list.name.title" text="표기명은 필수 입력 항목입니다." />" maxlength="30" autocomplete="off" data-form="name" required="required"/>
								</td>
								<!--
								<td>
									<table class="table table-detail m-n">
							...
							<tr>
								<th><spring:message code="menu.list.shrtDesc" text="짧은 표기명" /></th>
								<td>
									<input type="text" class="form-control" name="shrtDesc" value="" title="<spring:message code="menu.list.shrtDesc.title" text="짧은 표기명을 입력해주세요." />" maxlength="30" autocomplete="off" data-form="shrtDesc" />
								</td>
								<!--
								<td>
									<table class="table table-detail m-n">
							...
							<tr>
								<th><spring:message code="menu.list.longDesc" text="전체 표기명" /></th>
								<td>
									<input type="text" class="form-control" name="longDesc" value="" title="<spring:message code="menu.list.longDesc.title" text="전체 표기명을 입력해주세요." />" maxlength="50" autocomplete="off" data-form="longDesc" />
								</td>
								<!--
								<td>
									<table class="table table-detail m-n">
							...
							<tr>
								<th><spring:message code="menu.list.linkUrl" text="링크 URL" /></th>
								<td>
									<input type="text" class="form-control" name="linkUrl" value="" title="<spring:message code="menu.list.linkUrl.title" text="링크 URL을 입력해주세요." />" maxlength="30" autocomplete="off" data-form="linkUrl" />
								</td>
							</tr>
							<tr>
								<th><spring:message code="menu.list.linkType" text="링크 유형" /></th>
